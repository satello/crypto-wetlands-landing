    ...
    return (
        <div>
            <div style={{height: '600px', overflow: 'hidden'}}>
                ...
                <ImgBanner>p2p restoration. | envArt. | deFund. </ImgBanner>
            </div>
            <ContentContainer>
